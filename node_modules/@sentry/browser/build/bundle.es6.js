...
var Sentry = (function (exports) {
  ...
  function _htmlElementAsString(el, keyAttrs) {
      ...
      const keyAttrPairs = ((_a = keyAttrs) === null || _a === void 0 ? void 0 : _a.length) ? keyAttrs.filter(keyAttr => elem.getAttribute(keyAttr)).map(keyAttr => [keyAttr, elem.getAttribute(keyAttr)])
          : null;
      ...
      _installGlobalOnErrorHandler() {
          ...
          addInstrumentationHandler({
              ...
              callback: (data) => {
                  ...
                  const event = error === undefined && isString(data.msg)
                      ? this._eventFromIncompleteOnError(data.msg, data.url, data.line, data.column)
                      : this._enhanceEventWithInitialFrame(eventFromUnknownInput(error || data.msg, undefined, {
